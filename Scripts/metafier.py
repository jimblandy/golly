...
# Based on http://www.cranemtn.com/life/files/metafier.py.
...
# Dave Greene, 23 June 2006:  added support for any B?*/S?* rule
...
# for composing the tiles from subpatterns.  The delay is almost all
# due to running CellCenter[3680] at the end to produce the large
# filled area for the ONcell.  Subpatterns are generally (with some
# exceptions) defined to match the labeled slides at
...
def main():
    ...
    8b2o3b2o4$8b2o3b2o$4b2o2b2o3b2o$4b2o3b5o$10b3o$10b3o!""", 35, 1348) # P46OscAlt2 really
    ...
    2o$4b3o4b2o$5bo!""", 1375, 1980) # P46OscAlt2 really
    ...
    OFFcell = all + CellCenter + StateBit + RuleBits
    ...
    ONcell = all + CellCenter[3680] + RuleBits
    ...
    for j in xrange(selheight):
        for i in xrange(selwidth):
            golly.show("Placing (" + str(i+1) + "," + str(j+1) + ") tile in a " \
                       + str(selwidth) + " by " + str(selheight) + " rectangle.")
            if livecell[i][j]:
