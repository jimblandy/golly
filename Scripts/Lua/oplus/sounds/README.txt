...
Sound effects and music are available for breakout.lua. You need two things:
1. A build of Golly that is compiled with sound support (see the Makefiles for ENABLE_SOUND)
2. The audio files which can be downloaded as zip file from: http://lazyslug.no-ip.biz/lifeview/audio/breakout.zip
