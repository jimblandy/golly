...
echo EXTRA_DIST = ../../gui-wx/{makefile-{gtk,mac,win},CMakeLists.txt,Info.plist.in,*.mk,*.rc,configure/autogen.sh,icons,bitmaps} ../../docs $(find ../../gui-ios -type f | sort) ../../docs >>sources.am
